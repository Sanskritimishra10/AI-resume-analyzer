...
const Upload = () => {
    ...
    useEffect(() => {
        if (!auth.isAuthenticated) {
            // Stay on the page and let user login/signup
            return;
        }
    ...
    return (
        <main className="bg-[url('/public/public/images/bg-main.svg')] bg-cover min-h-screen">
            <Navbar />
                ...
                <div className="page-heading py-16 text-center">
                    ...
                    {!isProcessing && !auth.isAuthenticated && (
                        <div className="flex flex-col items-center gap-4 mt-8">
                            <p className="text-lg">Please log in or sign up to upload your resume.</p>
                            <button
                                onClick={handleLogin}
                    ...
                    {!isProcessing && auth.isAuthenticated && (
                        <form id="upload-form" onSubmit={handleSubmit} className="flex flex-col gap-4 mt-8">
                            ...
                            <button className="primary-button w-fit text-xl font-semibold" type="submit">
                                Analyze Resume
                            </button>
                        </form>
                    )}
